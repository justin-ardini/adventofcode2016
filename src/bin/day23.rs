...
fn main() {
  let path = "./inputs/day23.txt";
  let lines = read_lines(path);
  let mut instructions = parse_lines(&lines);
  println!("-- Part 1 --");
...
fn part1(instructions: &mut Vec<Instruction>) -> i32 {
  let mut regs = [0; 4];
  regs[0] = 7;
  let mut p: i32 = 0;
  loop {
...
fn part2(instructions: &mut Vec<Instruction>) -> i32 {
  let mut regs = [0; 4];
  regs[0] = 12;
  let mut p: i32 = 0;
  loop {
